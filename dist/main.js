...
// EXTERNAL MODULE: ./src/static/fonts/roboto.scss
var roboto = __webpack_require__(3);
...
const src_init = () => {
  accordion.init(document, {
    ...
    selectorAccordionItemHeading: `.${src_prefix}--accordion__heading`,
    selectorAccordionContent: `.${src_prefix}--accordion__content`,
    classActive: `${src_prefix}--accordion__item--active`
  });
